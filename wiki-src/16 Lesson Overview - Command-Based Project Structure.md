# 16 Lesson Overview: Command-Based Project Structure

Branch: `lesson-16-reading-a-command-based-project`
Reading Page: [16 Reading Material: Command-Based Project Structure](<16 Reading Material - Command-Based Project Structure>)
