...
- Which values are published for human observers?
- How do console messages and dashboard values complement each other?

## Success Check

- You can explain where a telemetry value is produced and where it is displayed.
